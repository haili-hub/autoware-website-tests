...
`playwright.config.ts` configures Chromium-only execution(We can add Safari, Webkit, etc. in future), with the following timeouts to accommodate the `autoware.org` site load:
